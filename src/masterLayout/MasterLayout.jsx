              ...
              localStorage.getItem("userRole") === "admin" && (
                <>
                  ...
                  <li>
                    <Link
                      href="/trainers"
                      className={pathname === "/trainers" ? "active-page" : ""}
                    >
                  ...
                  <li>
                    <Link
                      href="/schedule"
                      className={pathname === "/schedule" ? "active-page" : ""}
                    >
                      <i className="ri-circle-fill circle-icon text-info-main w-auto" />{" "}
                      Schedule
                    </Link>
                  ...
                  <li>
                    <Link
                      href="/expenses"
                      className={pathname === "/expenses" ? "active-page" : ""}
                    >
                      <i className="ri-circle-fill circle-icon text-info-main w-auto" />{" "}
                      Expenses
                    </Link>
                  ...
                  <li>
                    <Link
                      href="/payments"
                      className={pathname === "/payments" ? "active-page" : ""}
                    >
                      <i className="ri-circle-fill circle-icon text-info-main w-auto" />{" "}
                      Payments
                    </Link>
                ...
                <>
                  <li>
                    <Link
                      href="/memberRole"
                      className={
                        pathname === "/memberRole" ? "active-page" : ""
                      }
                    >
                      <Icon
                        icon="solar:home-smile-angle-outline"
                  ...
                  <li>
                    <Link
                      href="/memberRole/my-progress"
                      className={
                        pathname === "/memberRole/my-progress"
                          ? "active-page"
                          : ""
                      }
                    >
                  ...
                  <li>
                    <Link
                      href="/memberRole/attendance"
                      className={
                        pathname === "/memberRole/attendance"
                          ? "active-page"
                          : ""
                      }
                    >
                  ...
                  <li>
                    <Link
                      href="/memberRole/schedule"
                      className={
                        pathname === "/memberRole/schedule" ? "active-page" : ""
                      }
                    >
                      <Icon icon="bi:calendar2-week" className="menu-icon" />
                      <span>Schedule</span>
                  ...
                  <li>
                    <Link
                      href="/memberRole/memberworkoutplan"
                      className={
                        pathname === "/memberRole/memberworkoutplan"
                          ? "active-page"
                          : ""
                      }
                    >
              ...
              localStorage.getItem("userRole") === "staff" && (
                <>
                  <li>
                    <Link
                      href="/staff"
                      className={pathname === "/staff" ? "active-page" : ""}
                    >
                      <Icon
                        icon="solar:home-smile-angle-outline"
                        className="menu-icon"
